    ...
    <div class="breadcrumb-header justify-content-between align-items-center py-3 mb-4 border-bottom">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 align-items-center" style="background: transparent; padding: 0;">  
                    <li class="breadcrumb-item">
                        <h4 class="content-title mb-0 d-inline-block text-primary fw-bold">الفواتير</h4>
                    </li>   
        ...
        <div class="d-flex my-xl-auto right-content">
            <div class="pr-1 mb-3 mb-xl-0">
                <button type="button" class="btn btn-primary btn-icon ml-2 shadow-sm">
                    <i class="mdi mdi-plus"></i> إضافة فاتورة
                </button>
            </div>
        </div>
    </div>
